...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_header">
        <div id="site_title">
           ...
           <img src="images/shine.gif" height="50px" width="250px">
    ...
    <div id="templatemo_middle">
        ...
        <h1>Registration to Shine.com</h1>
               
       	<form action="shineregisterServlet" method="post" name="ureg" enctype="multipart/form-data" onsubmit="return validate()">
    	...
    	<tr>
 		...
 		<tr>
 			...
 			<tr>
 				...
 				<!-- <td><a href="ragister.jsp"><img src="images/reset.png" width="50" height="50" alt=""></img></a></td> -->
 			</tr>
 	
 			<tr align="center">
 				<td><input type="hidden" value="shine" id="hidden"></input></td>
