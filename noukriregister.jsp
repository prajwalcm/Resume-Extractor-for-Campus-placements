   ...
   <li><a href="#"><span class="portfolio"></span>About Us</a></li>
    ...
    <div id="templatemo_middle">
    	...
    	<div class="col_w540 float_l v_divider">
        	<h1>Registration To Naukri.com</h1>
         
     <form action="naukriregisterServlet" method="post" name="ureg" enctype="multipart/form-data" onsubmit="return validate()">
     ...
     <table border="10" cellspacing="5" cellpadding="5" align="center">
    	<tr>
 		...
 		<tr align="center">
 			...
 			<td><input type="hidden" value="noukri" id="hidden"></input></td>
 		</tr>
     </table>
       </form>
