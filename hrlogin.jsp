   ...
   <li><a href="#"><span class="portfolio"></span>About Us</a></li>
    ...
    <div id="templatemo_middle">
    	...
    	<div class="col_w540 float_l v_divider">
        	<center><h1>HR Login</h1></center>
                        <div class="cleaner h30"></div>
           
            <center>
       <form action="HRLogin" method="post" onsubmit="return validate()">
     
     <table>
     <tr>
     <th style="color: white;">Username </th><td><input type="text" name="username" id="username" placeholder="Username" required></input></td>
     </tr>
     <tr>
     <th style="color: white;">Password </th><td><input type="password" name="password" id="password" placeholder="Password" required></input></td>
     </tr>
     <tr>
     <td><br><input class="input-rounded-button" type="submit" value="LogIn" style="height: 30px;width: 80px;"/></td><!-- <td><br><a href="userregister.jsp"><img src="images/adduser.png" width="50" height="50" alt=""></img></a></td> -->
     </tr>
     </table>
       </form>
       </center>
