...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_header">
        ...
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a href="scheduletest.jsp"><span class="projects"></span>Schedule Test</a></li>
    ...
    <div id="templatemo_middle">
    	...
    	<div class="col_w540 float_l v_divider">
            ...
            <table border="0" cellpadding="10" cellspacing="10" style="width:100%; border:1px solid white;" >
                    <tr>
                  
                    	<td bgcolor="D7231C"><span style="color: white;font-weight: bold;">Sr. No. </span></td>
                        
                        <td bgcolor="D7231C"><span style="color: white;font-weight: bold;">UserName</span></td>
                        <td bgcolor="D7231C"><span style="color: white;font-weight: bold;">File</span></td>
                       <!--  <td bgcolor="D7231C"><span style="color: white;font-weight: bold;">Portal</span></td> -->
                       <td bgcolor="D7231C"><span style="color: white;font-weight: bold;">Action</span></td>
                       <td bgcolor="D7231C"><span style="color: white;font-weight: bold;">Acknowledgment</span></td>
                        <!-- <td style="color: white;">Sr. No.</td>
                        <td style="color: white;"><strong>UserName</strong></td>
                        <td style="color: white;"><strong>File</strong></td> -->
                   ...
                   // boolean Authorised=false;
                    ...
                    String hrskill=(String)session.getAttribute("skills");
    				String hrexperience=(String)session.getAttribute("experience");
    				String hrlocation=(String)session.getAttribute("location");
    				String hrsalary=(String)session.getAttribute("salary");
                    
    				  //Class.forName("com.mysql.jdbc.Driver").newInstance();
                    Connection con=DbConnection.getConnection();  
                     //   int Userid = Integer.parseInt((String)session.getAttribute("userId"));
                        int srno = 1;
                        PreparedStatement st= con.prepareStatement("select * from resumefile group by attribute");
                        //st.setString(1,hrskill);
                    ...
                    <tr align="center">
                       ...
                       <td> <%= srno++ %> </td>
                       <td><%= username %> </td>
                        <td onClick='window.open(src="UploadedFiles/<%= filename %>")'><a href="" style="color: white;"><%= filename %></a></td> 
                         <%-- <td><%= portal %> </td> --%>
                          <td><a href="download?id=<%= rs.getInt("id") %>" ><font color="#38cdff">Download</font></a></td>
                          <td><a href="email?email=<%= rs.getString("email") %>"><font color="#38cdff">Send Mail</font></a></td>
