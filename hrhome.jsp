...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_middle">
    	...
    	<div class="col_w540 float_l v_divider">
        	<h1>Welcome <%=session.getAttribute("hrusername") %></h1>
                        <div class="cleaner h30"></div>
           
           
            <!-- <form action="resumeextraction" method="post" onsubmit="return validate()"> -->
             <form action="resumefileextraction" method="post" onsubmit="return validate()">
            
            
    <center> <h3 style="color: white;">Sort Resume</h3></center>
 				<center><table>
 				<!-- <tr>
 				...
 				<tr>
 				<td>Skills &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="skills" id="skills" required> </td>
 				</tr>
 				<tr>
 				<td>Experience  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="skills" id="skills" required> </td>
 				</tr>
 				<tr>
 				<td>Percentage  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="skills" id="skills" required> </td>
 				</tr>
 				<!-- <tr>
 				<td>Skills &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="skills" id="skills" >
 				...
 				<!-- <tr>
 				<td>Experience <select name="experience" id="experience" >
       								<option value="select">----Select----</option>
 					...
 					<tr>
 				<td>Location &nbsp;&nbsp;&nbsp;&nbsp;<select name="location" id="location" >
       								<option value="select">----Select----</option>
 					...
 					<!-- <tr>
 				<td>Salary &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="salary" id="salary" >
       								<option value="select">----Select----</option>
       								<option value="1">1</option>
        							<option value="2">2</option>
        							<option value="3">3</option>
