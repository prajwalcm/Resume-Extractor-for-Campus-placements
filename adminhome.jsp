...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_header">
        ...
        <div id="templatemo_menu">
            <ul>
                <li><a href="adminhome.jsp" class="current"><span class="home"></span>Home</a></li>
                   ...
                   // boolean Authorised=false;
                    ...
                    Connection con=DbConnection.getConnection();  
                     //   int Userid = Integer.parseInt((String)session.getAttribute("userId"));
                        ...
                        ResultSet rs = st.executeQuery("select * from resume group by filename");
                        while(rs.next()){
                    ...
                    <tr>
                       ...
                       <td><%= username %> </td>
                        <td onClick='window.open(src="UploadedFiles/<%= filename %>")'><a href="" style="color: white;"><%= filename %> </a></td> 
                         <td><a href="downloadadmin?id=<%= rs.getInt("id") %>"><font color="#38cdff">Download</font></a></td>
