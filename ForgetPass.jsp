...
<div id="templatemo_wrapper">
   ...
   <li><a href="#"><span class="portfolio"></span>About Us</a></li>
    ...
    <div id="templatemo_middle">
       ...
       <form action="ForgetUser" method="post" onsubmit="return validate()">
     ...
     <tr>
	     <th style="color: white;">Old Password </th>
	     <td><input type="password" name="#" id="password" placeholder="Password" required></input></td>
     </tr>
     <tr>
	     <th style="color: white;">New Password </th>
	     <td><input type="password" name="newpassword" id="password" placeholder="Password" required></input></td>
     </tr>
     <tr>
	     <td><br><input class="input-rounded-button" type="submit" value="Update" style="height: 30px;width: 80px;"/></td>
	     <td><br><input type="reset" class="input-rounded-button" value="Reset" style="height: 30px;width: 120px;" /></td>
	 </tr>
