...
if(request.getParameter("succes")!=null){
	   out.println("<script>alert('Successfully Login to the Portal ...!');</script>"); 
}
if(request.getParameter("success")!=null){
	   out.println("<script>alert('Successfully Upload Resume to Naukri.com ...!');</script>"); 
}
%>
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_middle">
    	...
    	<div class="col_w540 float_l v_divider">
            ...
            <form action="sendResume" method="post" onsubmit="return validate()" enctype="multipart/form-data">
    		<h3 style="color: white;">Upload Your Resume Here.....</h3>
 			<table border="10" cellspacing="8" cellpadding="8" align="center">
 			
 				<tr>
 					<td>Select File <input type="file" name="file" id="file" required/></td>
 				</tr>									
    			<tr align="center">
