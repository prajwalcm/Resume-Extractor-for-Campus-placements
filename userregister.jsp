...
function AllowAlphabet() {
    ...
    if (!ureg.middlename.value.match(/^[a-zA-Z]+$/) 
    		&& ureg.middlename.value != "") {
    	ureg.middlename.value = "";
    	ureg.middlename.focus();
        alert("Please Enter only alphabets in text");
    }
    
    if (!ureg.lastname.value.match(/^[a-zA-Z]+$/)
            && ureg.lastname.value != "") {
    	ureg.lastname.value = "";
    	ureg.lastname.focus();
        alert("Please Enter only alphabet in text");
   ...
   <li><a href="#"><span class="portfolio"></span>About Us</a></li>
    ...
    <div id="templatemo_middle">
    	...
    	<div class="col_w540 float_l v_divider">
        	<h1 style="margin: -24px -0px 18px;">New Registration</h1>
        	
        	<form action="registerServlet" method="post" name="ureg" enctype="multipart/form-data" onsubmit="return validate()">
			<center>
			<table border="10" cellspacing="5" cellpadding="5" align="center">
 			
 			<tr>
	 			<td>Name </td>
	 			<td><input type="text" name="name" id="name" onkeyup="AllowAlphabet()" required></input></td>
	 	
	 			<td>Middle Name</td>
	 			<td><input type="text" name="middlename" id="middlename" onkeyup="AllowAlphabet()" required></input></td>
	 		</tr>
	 		<tr>
	 			<td>Last Name</td>
	 			<td><input type="text" name="lastname" id="lastname" onkeyup="AllowAlphabet()" required></input></td> 
 			
	 			<td>Age</td>
	 			<td><input type="text" name="age" id="age" maxlength="2" required></input></td>
 			</tr>
 			<tr>
	 			<td>Gender</td>
	 			<td>&nbsp;Male&nbsp;<input type="radio" name="gender" id="gender" value="male"></input> &nbsp;Female&nbsp;
 									<input type="radio" name="gender" id="gender" value="female"></input></td>
 			...
 			<tr>
	 			<td>Mobile No</td>
	 			<td><input type="text" name="mobno" id="mobno" pattern="[7|8|9][0-9]{9}" maxlength="10" onblur="Validate()" required></input></td>
 			...
 			<tr>
	 			<td>Password </td>
	 			<td><input type="password" name="password" id="password" onkeyup='check();' required></input></td>
 			
	 			<td>Confirm Password </td>
	 			<td><input type="password" name="confirm_password" id="confirm_password"  onkeyup='check();' required></input>
	 			<span id='message'></span></td>
 			</tr>
 			<tr align="center">
 				<td></td>
 				<td><input class="input-rounded-button" type="submit" value="submit" style="height: 30px;width: 80px;"></input></td>
 				<td><input type="reset" class="input-rounded-button" value="Reset" style="height: 30px;width: 120px;" /></td>
 				<td><input type="hidden" value="user" id="hidden" onkeyup="loadXMLDoc()"></input></td>
 			</tr>
