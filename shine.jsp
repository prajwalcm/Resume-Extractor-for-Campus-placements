...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_header">
        <div id="site_title">
           ...
           <img src="images/shine.gif" height="80px" width="250px">
    ...
    <div id="templatemo_middle">
    	...
    	<div class="col_w540 float_l v_divider">
        	<center><h1>User Login To Shine.com</h1></center>
                        <div class="cleaner h30"></div>
           
            <center>
       <form action="shineLogin" method="post" onsubmit="return validate()">
	     ...
	     <tr>
	     	...
	     	<td>Not a member as yet?<a href="shineregister.jsp"> Register Now</a></td>
	     </tr>
	     </table>
       </form>
       </center>
