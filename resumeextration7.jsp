                   ...
                   // boolean Authorised=false;
                    ...
                    Connection con=DbConnection.getConnection();  
                     //   int Userid = Integer.parseInt((String)session.getAttribute("userId"));
                        int srno = 1;
                        PreparedStatement st= con.prepareStatement("select username,filename from resume where experience=? and location=?");
                        st.setString(1,hrexperience);
                        st.setString(2,hrlocation);
