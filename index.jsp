    	...
    	<div class="col_w540 float_l v_divider">
        	<h1>Welcome to Resume Extraction</h1>
             ...
             <table align="center">
				<tr>
				<td>
				 <img src="images/people.png" width=40" height="40"><a href="userlogin.jsp">&nbsp;&nbsp;<span style="font-size:22px">Candidate Login</span></a></td>		 
				 </tr>
				 
				 <tr>
				<td>
				 <img src="images/people.png" width=40" height="40"><a href="adminlogin.jsp">&nbsp;&nbsp;<span style="font-size:22px">Admin Login</span></a></td> 
				 </tr>
				 
				 <tr>
				 <td>
				 <img src="images/people.png" width=40" height="40"><a href="hrlogin.jsp">&nbsp;&nbsp;<span style="font-size:22px">HR Login</span></a></td>
				 </tr>
				 
				 <tr>
				 <td>
				 <img src="images/people.png" width=40" height="40"><a href="ExamLogin.jsp">&nbsp;&nbsp;<span style="font-size:22px">Exam Section</span></a></td>
				 </tr>
            </table>
