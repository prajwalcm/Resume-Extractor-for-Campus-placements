...
if(request.getParameter("failed")!=null){
	   out.println("<script>alert('Ooops Invalid Parameter ...!');</script>"); 
}
   ...
   <li><a href="#"><span class="portfolio"></span>About Us</a></li>
    ...
    <div id="templatemo_middle">
    	...
    	<div class="col_w540 float_l v_divider">
        	<h1>User Login To Monster.com</h1>
               <div class="cleaner h30"></div>
          
       <form action="monsterLogin" method="post" onsubmit="return validate()">
	     ...
	     <tr>
	     	...
	     	<td>Not a member as yet?<a href="monsterregister.jsp"> Register Now</a></td>
	     </tr>
	     </table>
       </form>
